define([], function () {
    ...
    require.config({
        ...
        paths: {
            ...
            courseCatgory:'js/course/course_category',
            ...
            detepicker:'lib/bootstrap-datepicker/js/bootstrap-datepicker',
            ...
            jqueryRegion:'lib/jquert-region/jquery.region',
            nprogress:'lib/nprogress/nprogress',
        },
        shim:{
            //bootstrap是非define模块,需要依赖与jquery,所以需要配置
            bootstrap:{
                deps:['jquery'],
            }
        }
